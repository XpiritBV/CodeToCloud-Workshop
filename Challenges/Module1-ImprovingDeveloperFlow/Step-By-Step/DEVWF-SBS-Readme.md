# Overview of Step By Step Instructions and Videos

## Textual Step by Steps
* [DEVWF-T001 Get started with the work and create visibility](DEVWF-T001-SBS.md)
* [DEVWF-T002 Running the application locally](DEVWF-T002-SBS.md)
* [DEVWF-T003 Containerize the Application](DEVWF-T003-SBS.md)
* [DEVWF-T004 Optimize containers with a multi staged Docker File](DEVWF-T004-SBS.md)
* [DEVWF-T005 Catching Security Vulnerabilities](DEVWF-T005-SBS.md)
* [DEVWF-T006 Setting up a local infrastructure](DEVWF-T006-SBS.md)
* [DEVWF-T007 Set up Continuous Integration to push container images to GitHub Registry](DEVWF-T007-SBS.md)

## Video Step by Steps
* [DEVWF-T001 Get started with the work and create visibility](https://youtu.be/vcXU7R1xb6)
