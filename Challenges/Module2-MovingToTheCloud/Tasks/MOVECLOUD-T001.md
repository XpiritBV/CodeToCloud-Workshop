...
* Resource group [CodeToCloud-<STUDENTSUFFIX>] has been created
* Resource group contains a CosmosDB called [CTCDB-<STUDENTSUFFIX>]
* Resource group contains a AKS cluster called [CTCAKS-<STUDENTSUFFIX>]
