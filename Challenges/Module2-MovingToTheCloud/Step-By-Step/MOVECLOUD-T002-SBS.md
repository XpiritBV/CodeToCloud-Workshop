...
5. In the Azure Portal, navigate to the Web Application and open the Container Blade. In the Container blade, elect the Docker Compose Tab. Select Private Registry under Image Source. 
